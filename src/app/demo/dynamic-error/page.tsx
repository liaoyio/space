...
const ServerComponent = dynamic(() => import('./page.server').then((mod) => mod.ServerHomeLayout), {
  ssr: true,
});

const ServerDefaultComponent = dynamic(() => import('./page.server'), { ssr: true });

const ClientComponent = dynamic(() => import('./page.client').then((mod) => mod.ClientHomeLayout), {
  ssr: true,
});
