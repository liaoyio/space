      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div
            style={{
              background:
                'linear-gradient(90deg, #FFFFFF 0%,rgba(255, 255, 255, 0.2) 30%,rgba(255, 255, 255, 0.4) 50%, rgba(255, 255, 255, 0.2) 100%)',
              fontSize: '18px',
              fontWeight: 600,
              backgroundClip: 'text',
              fontFamily: 'Geist',
...
export async function GET(_: Request, { params }: Context) {
  ...
  try {
    const page = source.getPage(slug.filter((i) => i != 'posts'));
    if (!page) {
      return DefaultOGImage;
    }
